    ...
    <head>
        ...
        <script>
            ...
            function submitFormNo(){
                document.getElementById("docForm").setAttribute('action', "addLastDoc.php");
                document.getElementById("docForm").submit();
    ...
    <body>
        <main>
            ...
            <div class="container-fluid mt-50">
                <form action="addDocument.php" method="post" id="docForm" enctype="multipart/form-data">
                    <div hidden>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text">
                                <div class="row pt-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"id="filename"readonly class="form-control" name="filename">
                                    </div>
                                </div>
                                ...
                                <div class="pt-3">
                                    ...
                                    <a href="homePage.php" class="btn btn-secondary">Skip</a>
                                </div>
