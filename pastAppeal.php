...
<html lang="en">
  ...
  <main>
      <div style="margin:3%" id="featured-3" >
        <h2 class="pb-2 border-bottom"style="position:sticky;top:0;background-color:white">Past Appeals</h2>
        <div class="row g-4 py-5 row-cols-3 row-cols-lg-4" id="appealscontainer">
          <script>
            ...
            if(parent.PastAppeals.length<=0){
              thecontainer.innerHTML = "<h2>There is no Past Appeal for now</h2>";
            }else{
              parent.PastAppeals.forEach(appeal=>{
                ...
                thecontainer.innerHTML+= "<div class='feature col'style='min-width:200px;border: 2px solid green;border-radius: 25px;margin:3%;padding:1%;'>"+
                ...
                "<br><input type='text'disabled value='Expiry Date : "+appeal.toDate+"'style='width:100%'></p><p>Donation target : RM "+appeal.appealTarget+"</p><p>Outcome : "+appeal.outcome+"</p>"+
